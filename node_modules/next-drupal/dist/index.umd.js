(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('node-cache'), require('jsona'), require('qs'), require('react'), require('next/router')) :
  typeof define === 'function' && define.amd ? define(['exports', 'node-cache', 'jsona', 'qs', 'react', 'next/router'], factory) :
  (global = global || self, factory(global.nextDrupal = {}, global.nodeCache, global.jsona, global.qs, global.react, global.router));
}(this, (function (exports, NodeCache, Jsona, qs, React, router) {
  NodeCache = NodeCache && Object.prototype.hasOwnProperty.call(NodeCache, 'default') ? NodeCache['default'] : NodeCache;
  Jsona = Jsona && Object.prototype.hasOwnProperty.call(Jsona, 'default') ? Jsona['default'] : Jsona;
        ...
        try {
          ...
          var _temp2 = _catch(function () {
            return Promise.resolve(getMenu(name, {
              ...
              defaultLocale: router$1.defaultLocale
            })).then(function (data) {
              setData(data);
              setIsLoading(false);
            });
  ...
  exports.getJsonApiIndex = getJsonApiIndex;
  exports.getJsonApiPathForResourceType = getJsonApiPathForResourceType;
  exports.getMenu = getMenu;
  exports.getPathsFromContext = getPathsFromContext;
  exports.getResource = getResource;
  exports.getResourceByPath = getResourceByPath;
  exports.getResourceCollection = getResourceCollection;
  exports.getResourceCollectionFromContext = getResourceCollectionFromContext;
  exports.getResourceFromContext = getResourceFromContext;
  exports.getResourcePreviewUrl = getResourcePreviewUrl;
  exports.getResourceTypeFromContext = getResourceTypeFromContext;
  exports.getView = getView;
  exports.syncDrupalPreviewRoutes = syncDrupalPreviewRoutes;
